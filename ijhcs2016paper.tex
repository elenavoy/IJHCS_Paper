...
\subsection{Framework Use Demonstration}
{
In order to validate the conceptual framework and verify its stability, we used it to evaluate five of the applications that were used in the construction of the preliminary framework: Pinterest, Google Maps, Wikipedia, Delicious, and Yelp. A summary of present and absent action enablers and cognitive support mechanisms for these tools can be found in Table~\ref{table:tools_evaluation}

\begin{table}[htbp]
\small
\begin{tabular}{|p{0.15\columnwidth}| p{0.42\columnwidth}| p{0.42\columnwidth}|}

\hline
\textbf{Application} & \textbf{Present action enablers and cognitive support} & \textbf{Absent or limited action enablers and cognitive support}
\\
\hline
Pinterest       & Guided search / Category-based navigation / Resource-based referential navigation / Integrated referential navigation / Internal preservation of internal resources / Internal preservation of external resources / User subscriptions / Artifact subscriptions / Automatic notifications	& Opportunistic navigation / Textual previews / Automatic classification\\ \hline
Delicious       &  		&  \\
\hline
Wikipedia    &    	&  \\
\hline
...
\hline
\end{tabular}
\caption{Tool Features and Gaps}
% as of May 15, 2014}
\label{table:tools_evaluation} 
\end{table}
}
